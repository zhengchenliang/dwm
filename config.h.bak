...
static const char *fonts[]          = { "SauceCodePro Nerd Font Mono:size=11" }; // VITAL dwm font here
static const char dmenufont[]       = "SauceCodePro Nerd Font Mono:size=12"; // VITAL dmenu font here
static const char col_black[]       = "#000000"; // VITAL dwm and dmenu color defined here
...
static const char *colors[][3]      = { // VITAL dwm colors applied here
	/*               fg               bg               border   */
...
static char dmenumon[2] = "0"; // VITAL dmenu options colors applied here
...
// windows in page - main window in page left per vertical block - focus window is highlighted - windows can be tiled or floating
static Key keys[] = { // VITAL key complex
	...
	{ MODKEY,              XK_d,                    killclient,       {0} }, // terminate focus window
	...
	{ MODKEY,              XK_p,                    incnmaster,       {.i = -1 } }, // decrease one more main window (vertical layout)

  { MODKEY,              XK_u,                    hidewin,          {0} }, // hide focus window
	{ MODKEY,              XK_y,                    restorewin,       {0} }, // show hided window
	{ MODKEY|ShiftMask,    XK_u,                    hideotherwins,    {0} }, // hide other windows
